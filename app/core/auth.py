...
class Auth:
    ...
    def register(self, username, password, codigo):
        """
        Gerencia toda a lógica de registro para qualquer tipo de usuário.
        Esta é a "lógica de negócios" que movemos da tela.
        ...
        try:
            ...
            if not codigo:
                success, msg, user_id = self.db.register_user(username, password, "Paciente")
                if success:
            ...
            if codigo_master_id:
                ...
                success, msg, user_id = self.db.register_user(username, password, "Psicólogo")
                if success:
            ...
            if psicologo_id:
                ...
                success, msg, paciente_id = self.db.register_user(username, password, "Paciente")
                if not success:
                    return False, msg  # Ex: "Usuário já existe"
